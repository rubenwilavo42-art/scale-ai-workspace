// Put the freshly built ScalAI into /Applications, safely.
//
// Written after doing it by hand went wrong: the check for "is ScalAI running"
...
const built = path.join(root, 'release', 'mac-arm64', 'ScalAI.app');
const target = '/Applications/ScalAI.app';
