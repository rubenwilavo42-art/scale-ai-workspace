// Downloading and swapping in a new ScalAI. The part that can brick an install.
//
...
//
//   Nothing is installed while ScalAI is running. main.js kills every pty and
...
// says "Getting ScalAI 0.1.4…" forever is worse than one that admits defeat and
...
// update that misses its moment is never installed by anything, ever. ScalAI
...
// process to actually go, and anyone who reopens ScalAI inside that window — 30
