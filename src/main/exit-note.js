...
// node-pty's kill() sends, and therefore what quitting ScalAI, closing a window,
...
//
// So: say who ended it. ScalAI closing a session says so. A program that finished
...
function exitNote({ code, signal, deliberate } = {}) {
  // ScalAI pulled the plug: quitting, closing the window, closing the tile. The
