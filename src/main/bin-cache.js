...
//
// ScalAI answers "is this agent installed" properly in exactly one place:
...
// login PATH captured once at app start, so an agent installed *inside* ScalAI
...
// ---- spawn flags -----------------------------------------------------------
// Flags ScalAI always adds when it spawns a given agent, as opposed to anything
// the user or the resume path asked for.
//
// grok is the only entry and --minimal is the reason the table exists: without
// it grok paints a full-screen TUI over the ScalAI theme instead of printing
