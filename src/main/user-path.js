...
// homebrew, no nvm, no bun, no ~/.local/bin. Every agent ScalAI then spawns
...
// the one moment it does. An installer run inside ScalAI writes a PATH line into
...
// ScalAI had just installed was unspawnable until the app was restarted.
//
