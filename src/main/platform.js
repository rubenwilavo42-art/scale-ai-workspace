// Everything ScalAI assumes about the operating system, in one place.
//
...
//
// ScalAI ships macOS-only on purpose (see the shipping spec), so the darwin
...
// Dock-launched ScalAI (which inherits no PATH at all) reported perfectly
...
// first (it is the truth when ScalAI *was* started from a terminal), then the
