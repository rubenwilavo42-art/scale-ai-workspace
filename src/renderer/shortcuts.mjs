// One offline reference, shared by Paramètres and Quick Start.
export const OPEN_OUTPUT_COPY = 'Hold Command (⌘) and click a link or file path in a session. Web links open in your browser. Fichiers open here in ScalAI.';
...
export const SHORTCUT_GROUPS = [
  {
    ...
    rows: [
      ...
      ['Open a file in ScalAI', ['⌘', 'click'], 'In session output · opens the file here'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['New window', ['⇧', '⌘', 'N']],
      ['Open Paramètres', ['⌘', ',']],
      ['Enregistrer the active file', ['⌘', 'S']],
      ['Fermer the active pane', ['⌘', 'W']],
