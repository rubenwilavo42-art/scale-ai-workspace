...
// Codex agent somebody wrote by hand was invisible to ScalAI, and Codex was the
...
// marker hides ScalAI's own copies, a hand-made file is theirs, and the slug is
// the filename.
...
before(() => {
  ...
  write(path.join(home, '.claude/agents/copied.md'),
    '---\nname: copied\ndescription: A copy.\n---\n\n<!-- made by ScalAI from agents/copied.md — edit that file; this copy is regenerated -->\n\nbody\n');
});
...
// ScalAI's own create writes the singular.
