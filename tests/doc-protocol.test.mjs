// The security boundary of the scalai-doc:// scheme: a served path must resolve
...
test('a non-scalai-doc url is rejected', () => {
  assert.equal(parseDocUrl('file:///etc/passwd'), null);
  assert.equal(parseDocUrl('http://evil.test/x'), null);
  assert.equal(parseDocUrl('scalai-doc://other/foo'), null); // wrong host
});
