...
test('browser settings lead with downloads and import, with no agent-access sheet', () => {
  const html = browserParamètresContent({ enabled: true, sessions: [{ id: 's', title: 'Codex', views: ['v'], peers: [] }], profiles: [{ id: 'p', name: '<private>', active: true }] }, { onProfiles() {}, onImportCookies() {} });
