// Node runs two normal (non-demo) ScalAI processes against one disposable profile.
...
if(!process.versions.electron){
  (async()=>{
    ...
    try{
      ...
      console.log('PASS: normal ScalAI restart restores tab profiles, default, profile settings and usable local website data without reimport.');
